...
public class RemoveStopWordsTest {
    ...
    public void shouldRemoveStopWords() throws Exception {
        String text =
                "ONLY 2HOURS LEFT!! Cast your vote! http://t.co/8tNPSfdgd5 Help make the world a more literate and creative place! @LAReviewofBooks #LA2050";

        // Clean text
        String textCleaned = _tweetCleanerService.setText(text).cleanHashtag().cleanMentions()
