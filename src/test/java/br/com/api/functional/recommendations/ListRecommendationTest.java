...
public class ListRecommendationTest {
    ...
    public void shouldListRecommendationsBySocialCapital() throws Exception {
        ...
        ResultActions responseRecommendationsByType = mvc.perform(post("/recommendations/bytype")
        ...
        List<RecommendationItemJson> recommendedItems = new Gson().fromJson(
                responseRecommendationsByType.andReturn().getResponse().getContentAsString(),
                tipoLista);
